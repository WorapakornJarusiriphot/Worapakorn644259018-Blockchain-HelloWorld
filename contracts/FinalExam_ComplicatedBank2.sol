...
contract ComplicatedBank {
    ...
    modifier onlyOwner{
        require(msg.sender == owner, "Only owner can do this"); // คำถามที่ 3: กรอกเงื่อนไขการตรวจสอบเจ้าของ.
        _;
    }
    ...
    function deposit() public payable {
        balance[msg.sender] += msg.value; // คำถามที่ 5: เติมช่องว่างเพื่ออัปเดตยอดเงินของผู้ฝากถูกต้อง.
    }
