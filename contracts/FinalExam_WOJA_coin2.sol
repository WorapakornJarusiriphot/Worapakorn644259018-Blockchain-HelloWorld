...
contract WOJAToken is ERC20 {
    ...
    constructor() ERC20("WOJAToken", "WOJA")  {    
        _mint(address(this), 50000000 * 10 ** decimals()); // คำถามที่ 2: เติมใครควรได้รับโทเคนเมื่อสัญญาถูกสร้าง และจำนวนโทเคนที่พวกเขาควรได้รับคือเท่าไหร่?
    }

    function buy() payable public {
        uint tokenReceived = msg.value * exChangeRateForOneEther; // คำถามที่ 3: คำนวณจำนวนโทเคนที่ควรได้รับเมื่อซื้อด้วย ether.
        _transfer(address(this), msg.sender, tokenReceived); // คำถามที่ 4: ใครควรจะเป็นผู้ส่ง, ผู้รับ และจำนวนโทเคนที่ควรโอนคือเท่าไหร่?
    }
}
